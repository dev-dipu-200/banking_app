...
export default function Toast({
  ...
  return (
    <div
      className={`flex items-start gap-3 p-4 rounded-lg border-l-4 shadow-lg backdrop-blur-sm transition-all duration-300 ${toastStyles[type]} animate-slide-in-right`}
    >
